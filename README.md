...
This repository contains a series of assessed coursework notebooks completed as part of the `Mathematics and Applications of Machine Learning' module at the University of Manchester.

The work focuses on applied data analysis, supervised learning, and predictive modelling, combining theoretical foundations with practical implementation using Python.

Test 1 - Applied Data Analysis & Time Series Exploration (97%)
- Analysis of real-world UK housing price data from government sources
- Data cleaning, validation, and feature selection using pandas and NumPy
- Regional and time-based aggregation of sales and price data
